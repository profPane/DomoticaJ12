...
public class Lamp extends Attuatore {
    ...
    protected int maxLux; //luminosita massima espressa in lux

    public Lamp(String sn, String marca, String modello, int carica, int maxLux) {
        super(sn, marca, modello,  carica);
        this.maxLux = maxLux;
        this.stato = 0;
    }
    
    public String nextState() { //passo al prossimo stato
    ...
    protected String stato(){ return this.stati[this.stato]; }
